...
- **Previous:** [P0.03 — core package skeleton](03-core-package-skeleton.md) created the
  buildable `@md-context-audit/core` shell with Zod and build/test wiring.
- **Next:** [P0.05 — cli package + commander](05-cli-package-commander.md) imports these
  relocated modules from `@md-context-audit/core` instead of relative `src` paths.
...
P0.05 can build the CLI purely on top of `@md-context-audit/core`'s exports; P0.06 can
