...
> right package, then lift-and-shift the MVP into `@md-context-audit/core` **without
...
is a workspace with `@md-context-audit/{core,cli,mcp-server}` so the MCP server and CLI
...
| [P0.03](03-core-package-skeleton.md) | `@md-context-audit/core` package skeleton | S | P0.02 |
| [P0.04](04-migrate-mvp-to-core.md) | Migrate MVP source into core (behavior-preserving) | M | P0.03 |
| [P0.05](05-cli-package-commander.md) | `@md-context-audit/cli` + commander scaffold (port scan/graph) | M | P0.04 |
| [P0.06](06-mcp-server-skeleton.md) | `@md-context-audit/mcp-server` package skeleton (stub) | S | P0.04 |
...
- [ ] MVP behavior preserved: `md-context-audit scan` and `graph` produce the same output
