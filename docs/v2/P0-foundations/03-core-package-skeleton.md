# P0.03 · `@md-context-audit/core` package skeleton
...
Create an empty-but-buildable `@md-context-audit/core` package that the CLI and MCP server
...
1. `packages/core/package.json`: name `@md-context-audit/core`, `"type": "module"`,
