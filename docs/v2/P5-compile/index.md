...
| [P5.03](03-describe-rules.md) | `describeRules` from the metadata source (incl. custom) | S | P5.01 |
...
- [ ] CLI `compile` with `--outdir`/`--dry-run`, default `.claude/skills/md-context-audit/`;
