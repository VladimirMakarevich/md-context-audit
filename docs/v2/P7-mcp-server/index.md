...
> deterministic MCP tools — a **thin stdio adapter over `@md-context-audit/core`** with
...
| --- | --- | --- | --- |
| [P7.01](01-server-foundation.md) | Server foundation: modular layout, shared helper, conventions | — | P2/P4/P5 done |
