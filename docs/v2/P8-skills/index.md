...
| [P8.02](02-skill-init.md) | `md-context-audit-init` skill | S | P8.01, P6 |
| [P8.03](03-skill-fix.md) | `md-context-audit-fix` skill | M | P8.01, P3 (`--fix`) |
| [P8.04](04-skill-impact.md) | `md-context-audit-impact` skill | S | P8.01, P7 |
...
- [ ] `skills/md-context-audit-{init,fix,impact}/SKILL.md` exist with valid frontmatter
...
- [ ] Content is host-neutral (no Claude-specific syntax, the vendor-neutral skill distribution decision); placeholders replaced
      with `VladimirMakarevich/md-context-audit` (S7).
