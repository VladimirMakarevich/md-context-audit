# P8.02 · `md-context-audit-init` skill
...
1. `skills/md-context-audit-init/SKILL.md` with valid frontmatter (P8.01).
2. Workflow: detect existing config → run smart CLI `init` ([P6](../P6-init/index.md), which
   now does cluster detection + inference) → confirm draft → install `@md-context-audit/cli`
