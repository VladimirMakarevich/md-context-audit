...
1. Rewrite `README.md`: the three install channels — CLI (`npm i -D @md-context-audit/cli`),
   MCP (`npx @md-context-audit/mcp-server` + host snippet), skills
   (`gh skill install VladimirMakarevich/md-context-audit <skill> --pin vX.Y.Z`,
